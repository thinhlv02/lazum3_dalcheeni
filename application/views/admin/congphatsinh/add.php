...
<div class="page-title">
    <div class="title_left"><h3>Thêm công phát sinh</h3></div>
    <div class="title_right">
        <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
            <!--            <a href="-->
            <?php //echo admin_url('card/add') ?><!--" class="btn btn-primary btn-sm">Thêm mới</a>-->
    ...
    <form id="formAddProduct" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-md-7 col-sm-7 col-xs-12">
                <input type="text" name="event" placeholder="sự kiện"
        ...
        <div class="form-group">
            ...
            <!--            <span style="float: left;margin-top: 7px">Số</span>-->
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input type="text" name="money" required placeholder="money"
                       class="form-control col-md-7 col-xs-12">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <select class="select2_group form-control" name="type">
                    <option value="0">Công phát sinh</option>
                    <option value="1">Tiền phạt</option>
                </select>
            </div>
        ...
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-2" style="width: 70px">
                <input type="submit" id="btnAddEvent" name="btnAddcongphatsinh" required class="btn btn-success"
                       value="Thêm">
            </div>
        </div>
    </form>
