    ...
    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-md-7 col-sm-7 col-xs-12">
                <input type="text" id="txtName" name="txtName"
                       value="<?php echo $card->name ?>" required
        ...
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Tên hiển thị<span
                        class="required">*</span></label>
            <div class="col-md-7 col-sm-7 col-xs-12">
                <input type="text" id="" name="displayName"
                       value="<?php echo $card->displayName ?>" required
                       class="form-control col-md-7 col-xs-12">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-7 col-sm-7 col-xs-12">
                <!--                <textarea rows="4" cols="100" name="info" class="col-md-7 col-xs-12">-->
                <!--                    --><?php //echo $card->info ?>
                <!--                </textarea>-->
                <input type="text" name="info" value="<?php echo $card->info ?>" required placeholder="thông tin thẻ"
                       class="form-control col-md-7 col-xs-12">
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-2" style="width: 70px">
                <input type="submit" id="btnUpdateEvent" name="btnUpdatecard" required
