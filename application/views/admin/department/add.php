...
<div class="page-title">
    <div class="title_left"><h3>Thêm phòng ban </h3></div>
    <div class="title_right">
        <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
<!--            <a href="--><?php //echo admin_url('department/add') ?><!--" class="btn btn-primary btn-sm">Thêm mới</a>-->
            <a href="<?php echo admin_url('department') ?>" class="btn btn-info btn-sm">Danh sách</a>
        </div>
    </div>
</div>
...
<div class="x_panel">
    ...
    <form id="formAddProduct" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="first-name">Tên<span
        ...
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="first-name">Mô tả<span
                        class="required">*</span></label>
            <!--            <span style="float: left;margin-top: 7px">Số</span>-->
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text"  name="description" required placeholder="Mô tả"
                       class="form-control col-md-7 col-xs-12">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-2" style="width: 70px">
                <input type="submit" id="btnAddEvent" name="btnAdddepartment" required="required" class="btn btn-success"
                       value="Thêm">
            </div>
        </div>
    </form>
