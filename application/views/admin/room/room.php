...
<div class="page-title">
    <div class="title_left"><h3>Danh sách lớp học</h3></div>
    <div class="title_right">
        <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
            <?php if ($menu_access[6] == 2) { ?>
...
<div class="x_panel">
    <div class="x_title">
        <h2>Danh sách (<?php echo count($res) . ' lớp học' ?>)</h2>
        ...
        <table id="datatable-product" class="table table-striped table-bordered bulk_action">
            ...
            <?php foreach ($res as $key => $value): ?>
                ...
                <tr>
                    ...
                    <?php if ($menu_access[6] == 2) { ?>
                        <td><a href="<?php echo admin_url('room/edit/') . $value->id ?>"
...
<script type="text/javascript">
    function confirm_del_event(id) {
        var r = confirm("Bạn có chắc chắn muốn xóa lớp học này?");
        if (r == true) {
            window.location.href = "<?php echo admin_url('room/del/')?>" + id;
        }
    }
</script>
