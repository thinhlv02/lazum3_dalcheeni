...
<div class="page-title">
    <div class="title_left"><h3>Bảng chấm công <span
                    style="color: red;text-transform: uppercase ">Bộ phận kinh doanh</span></h3></div>
                    ...
                    <?php foreach ($arr_week as $key => $value): ?>
                        ...
                        foreach ($arr_branch_id as $key => $value1):
                            ...
                            <tr>
                                ...
                                ?><!--</td>-->
                                <td style="font-weight: bold"><?php echo $this->branch_model->get_info($value1)->name ?></td>
                                <td>
                                    <?php $dem = ''; ?>
                                    <?php foreach ($value->data as $data) {
                                        if ($data['branch_id'] == $value1 && $data['date'] == $tuan->mon) {
                                            $check_id_teach = $this->schedule_week_kd_model->check_id_teach($data['id'], $value->week_id, 'mon');
//                                            pre($check_id_teach);
                                            if ($check_id_teach) {
                                                $total++;
                                                $dem++;
                                ...
                                <td>
                                    ...
                                    <?php foreach ($value->data as $data) {
                                        if ($data['branch_id'] == $value1 && $data['date'] == $tuan->tue) {
                                            $check_id_teach = $this->schedule_week_kd_model->check_id_teach($data['id'], $value->week_id, 'tue');
//                                            pre($check_id_teach);
                                            if ($check_id_teach) {
                                            $total++;
                                            $dem++; }
                                ...
                                <td>
                                    ...
                                    <?php foreach ($value->data as $data) {
                                        if ($data['branch_id'] == $value1 && $data['date'] == $tuan->wed) {
                                            $check_id_teach = $this->schedule_week_kd_model->check_id_teach($data['id'], $value->week_id, 'wed');
//                                            pre($check_id_teach);
                                            if ($check_id_teach) {
                                            $total++;
                                            $dem++; }
                                ...
                                <td>
                                    ...
                                    <?php foreach ($value->data as $data) {
                                        if ($data['branch_id'] == $value1 && $data['date'] == $tuan->thu) {
                                            $check_id_teach = $this->schedule_week_kd_model->check_id_teach($data['id'], $value->week_id, 'thu');
//                                            pre($check_id_teach);
                                            if ($check_id_teach) {
                                            $total++;
                                            $dem++; }
                                ...
                                <td>
                                    ...
                                    <?php foreach ($value->data as $data) {
                                        if ($data['branch_id'] == $value1 && $data['date'] == $tuan->fri) {
                                            $check_id_teach = $this->schedule_week_kd_model->check_id_teach($data['id'], $value->week_id, 'fri');
//                                            pre($check_id_teach);
                                            if ($check_id_teach) {
                                            $total++;
                                            $dem++; }
                                ...
                                <td>
                                    ...
                                    <?php foreach ($value->data as $data) {
                                        if ($data['branch_id'] == $value1 && $data['date'] == $tuan->sat) {
                                            $check_id_teach = $this->schedule_week_kd_model->check_id_teach($data['id'], $value->week_id, 'sat');
//                                            pre($check_id_teach);
                                            if ($check_id_teach) {
                                            $total++;
                                            $dem++; }
