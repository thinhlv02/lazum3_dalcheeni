...
<div class="page-title">
    <div class="title_left"><h3>Danh sách tuần <span style="font-weight: bold;text-transform: uppercase;color: red;">bộ phận kinh doanh</span>
        </h3></div>
        ...
        <table id="datatable-product" class="table table-striped table-bordered bulk_action">
            ...
            <?php foreach ($res as $key => $value): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo admin_url('schedule_week_kd/detail_week_kd/') . $value->id ?>"
                           class="btn btn-info btn-xs">Chi tiết KD</a>
                    </td>
