...
<!--                        class="required">*</span></label>-->
<!--            <div class="col-md-3 col-sm-3 col-xs-12">-->
<!--                <input type="text" name="level_room" required-->
<!--                       class="form-control col-md-7 col-xs-12">-->
<!--            </div>-->

            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="first-name">SL học viên<span
                        class="required">*</span></label>
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input type="text" name="hv" required
                       class="form-control col-md-7 col-xs-12">
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">K<span
                        class="required">*</span></label>
            <div class="col-md-1 col-sm-1 col-xs-12">
                <input type="text" name="K" class="form-control col-md-7 col-xs-12">
            </div>
